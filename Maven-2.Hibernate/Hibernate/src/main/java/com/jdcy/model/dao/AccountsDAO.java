...
import com.jdcy.model.entity.persist.Accounts;

/**
 * Home object for domain model class Accounts.
 * 
 * @see com.jdcy.model.entity.persist.Accounts
...
public class AccountsDAO {
	...
	public Accounts findById(java.lang.Integer id) {
		...
		try {
			Accounts instance = (Accounts) sessionFactory.getCurrentSession()
					.get("com.jdcy.model.entity.persist.Accounts", id);
			if (instance == null) {
	...
	public List findByExample(Accounts instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.jdcy.model.entity.persist.Accounts")
